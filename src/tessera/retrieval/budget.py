...
# declared budget" invariant. The retrieval pipeline and the MCP tool
# surface both hang budgets off this shape, so it is deliberately a
# stable boundary contract rather than an internal helper.
